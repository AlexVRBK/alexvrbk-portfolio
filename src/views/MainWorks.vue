    ...
    <div class="flex flex-col divCenter pt-5">
      ...
      >
        ...
        <div class="2xl:pt-2 xl:max-w-[40rem]">
          ...
          <strong class="decoration-2 underline"><a :href="value.Sidenote">View this project on your website</a></strong>

          <br />
          <strong class="decoration-2 underline mt-4"
...
export default {
	...
	mounted() {
		...
		new TypeIt('#works_intro', {
			...
			.type('Here is a list of projects I worked on!')
			.go();

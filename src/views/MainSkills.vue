    ...
    <div>
      <div>
        ...
        <p class="lg:text-lg text-sm text-justify leading-6">
          &nbsp;&nbsp;&nbsp;&nbsp; Front-end developer focusing on
          <strong> VueJS and Nuxt</strong>. I also possess skills such as communication skills, creativity, problem solving and adaptability.
        </p>
      </div>
      <br />
      <br />
